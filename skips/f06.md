...
3. **Review Style Guide for This Module:**
   - **Download Button:** Outline variant with download icon
   - **Loading State:** Show spinner with "Generating..." text
   - **Button Placement:** In card footer or action column
   - **Icon Size:** 16px (h-4 w-4) for button icons
   - See `guidelines/STYLE_GUIDE.md` → "M06: PDF Generation" section
