...
4. **Review Style Guide for This Module:**
   - **Signature Canvas:** White background, light gray border, 3:1 aspect ratio
   - **Pen Settings:** Color (alice-blue-900), width (2px)
   - **Button Placement:** Clear button in top-right corner of canvas
   - **Signing Page Layout:** Contract text centered (max-width: 800px), canvas below
   - **Checkbox Pattern:** "I agree to the terms" before sign button
   - See `guidelines/STYLE_GUIDE.md` → "M05: Contract & E-Signature" section

5. **Research Canvas Signature:**
